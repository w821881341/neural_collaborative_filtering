...
from keras.layers import Embedding, Input, Dense, merge, Reshape, Merge, Flatten, Dropout,Layer
...
def get_model(num_users, num_items, mf_dim=10, layers=[10], reg_layers=[0], reg_mf=0):
    ...
    z_mean = Dense(layers[-1])(predict_vector)
    z_log_var = Dense(layers[-1])(predict_vector)
    pred_seq = VIB(0.1)([z_mean, z_log_var])
    # Final prediction layer
    prediction = Dense(1, activation='sigmoid', init='lecun_uniform', name="prediction")(pred_seq)
